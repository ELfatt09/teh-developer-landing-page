...
function Hero() {
  ...
  return (
    <section id='beranda' className='mt-20 w-full min-h-screen flex flex-col items-center justify-center bg-background text-text'>
      ...
      <div className='w-full text-center flex flex-col items-center'>
        ...
        <div className='mt-24 h-72 overflow-hidden w-full mb-10 bg-primary shadow-primary/50 shadow-[inset_10px_4px_8px_1px_rgba(1,0,0,1)]'>
