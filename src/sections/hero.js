...
function Hero() {
  ...
  return (
    <section className='mt-20 w-full min-h-screen flex flex-col items-center justify-center bg-background text-text'>
      <div className='w-full max-w-5xl flex items-center justify-between px-8'>
        <h1 className='text-5xl md:text-7xl mt-10 font-sans font-medium leading-relaxed  md:leading-loose tracking-tighter text-center'>
      ...
      <div className='w-full text-center flex flex-col items-center'>
        ...
        <a href='#kontak' className='no-underline transition duration-300 bg-primary shadow-primary text-background hover:bg-secondary/50 hover:scale-105 hover:text-primary hover:shadow-xl px-5 py-2 mt-6 text-xl font-sans font-medium tracking-tight rounded-full'>
          Kontak Kami
        </a>
