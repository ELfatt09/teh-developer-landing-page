...
function Footer() {
    return (
        ...
        <div className='w-full bg-primary py-10 flex flex-col md:flex-row px-6 lg:px-16 items-center justify-between text-text space-y-10 md:space-y-0'>
            <div className='w-full md:w-1/2 px-4'>
                ...
                <div className='w-full flex flex-col text-lg space-y-4'>
                    ...
                    <a className='text-background no-underline hover:underline' href="https://wa.me/6281381593080" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp contact">
                        <i className="fa-brands fa-whatsapp mr-3"></i>+62 813-8159-3080
                    </a>
                    <a className='text-background no-underline hover:underline' href="https://instagram.com/tehdancode" target="_blank" rel="noopener noreferrer" aria-label="Instagram profile">
                        <i className="fa-brands fa-instagram mr-3"></i>@tehdancode
                    </a>
                </div>
                <a href='#beranda' className='transition duration-300 mt-8 border-background hover:bg-background hover:text-primary border-4 text-background text-md font-semibold uppercase py-2 px-4 inline-flex items-center' aria-label="Back to top">
            ...
            <div className='w-full md:w-1/2 mt-8 md:mt-0 flex flex-col px-8'>
                ...
                <ul className='space-y-4 text-lg list-disc text-background' aria-label="Navigation menu">
        ...
        <p className='text-center text-background text-sm bg-primary py-4' aria-label="Copyright notice">
            2025 - <span className='font-semibold'>Sevalino Elfata</span>. All Rights Reserved.
        </p>
        </>
            );
}
